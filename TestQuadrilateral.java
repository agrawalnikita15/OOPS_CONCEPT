...
public class TestQuadrilateral
{
	...
	{
		Square sq=new Square(15,15,25,15,25,25,15,25);
		...
		Parallelogram p=new Parallelogram(15,15,35,15,25,25,0,25,8);
		System.out.println("Area Of The Parallelogram is " + p.area());
		Trapezoid t=new Trapezoid(15,15,35,15,45,25,0,25,18);
